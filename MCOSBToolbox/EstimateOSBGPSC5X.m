...
%------------------------------------------------------------------------------------------------------
function [GPSOSB,SatC1C,SatC1W,SatC2W,SatC2X] = EstimateOSBGPSC5X(GSatTypeNum,RecTypeNum,NumPar,NumRecPar,NumRec,NBB,W)
    %Number of code type
    NumType = 5;
    FL1  = 1.57542E9;
    FL2  = 1.22760E9;
    ...
    iSated = NumRecPar +SatC1C + SatC1W + SatC2W + SatC2X;
    CTemp = linspace(0,0,NumPar);
    CTemp(iSatst:iSated) = ones(1,SatC2X);
    C3 = [C3;CTemp];
    clear CTemp;
    % C5X
    iSatst = NumRecPar +SatC1C + SatC1W + SatC2W + SatC2X + 1;
    iSated = NumRecPar +SatC1C + SatC1W + SatC2W + SatC2X + SatC5X;
    CTemp = linspace(0,0,NumPar);
    CTemp(iSatst:iSated) = ones(1,SatC5X);
    C3 = [C3;CTemp];
    clear CTemp;  
