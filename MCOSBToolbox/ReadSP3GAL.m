...
%------------------------------------------------------------------------------------------------------
function [sate] = ReadSP3GAL(ipath,DOYth,sate_mark,year)
    ...
    for i=1:len
        ...
        [~, GAL1, ~] = read_precise_eph(pr_obs);
        [~, GAL2, ~] = read_precise_eph(cu_obs);
        [~, GAL3, ~] = read_precise_eph(nx_obs);
        galx1 = GAL1.X; galy1 = GAL1.Y; galz1 = GAL1.Z;
        galx2 = GAL2.X; galy2 = GAL2.Y; galz2 = GAL2.Z;
        galx3 = GAL3.X; galy3 = GAL3.Y; galz3 = GAL3.Z;
        ...
        gall=size(sate.galx,2);
        if gall<galsate
            sate.galx(:,gall+1:galsate)=0;
            sate.galy(:,gall+1:galsate)=0;
            sate.galz(:,gall+1:galsate)=0;
        end
        break;
    end
end
