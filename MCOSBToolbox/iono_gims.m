...
% Interpolates VTEC from (global) ionosphere map (IONEX-format). The IONEX maps are give in UTC time but interpolation is based on gps-time (the
...
% Frequency
% use only single frequencies e.g. GPS L1 or L2 since the linear combinations of these will not work!!!
