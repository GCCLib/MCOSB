...
% Calulates the value of the mapping function for ionospheric correction from an ionex file.
% The point of interest for which a TEC value has to be estimated is not the location of the receiver but the location of the sub-ionospheric point. 
% The geocentric spherical coordinates of the sub-ionospheric point can be  computed from the receiver coordinates and the azimuth- and zenith angles
% a, z of the receiver
% 
% INPUT:
...
zi = asin((RE)/(RE+H)*sin(z));  % zenith angle in the IPP [rad]
